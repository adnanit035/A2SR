...
dataset_path = r'C:\Users\adnan\Downloads\Compressed\RAHBAR-Updated\face_recognition\dataset_preparation\uni_teachers_cropped'
img_train_test_split(dataset_path, 0.7)
